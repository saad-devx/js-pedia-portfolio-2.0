...
export const BgBeamsWithCollision = ({
    children,
    className
}) => {
    ...
    return (
        (<div
            ref={parentRef}
            className={cn(
                "h-screen md:h-[85vh] py-8 px-4 md:px-16 bg-gradient-to-b from-gray-100 to-neutral-200 relative flex items-center w-full justify-center overflow-hidden",
                className
            )}>
            {beams.map((beam) => (
                <CollisionMechanism
