...
export const LaptopScroll = ({
    ...
    const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, isMobile ? 1 : 2]);
        ...
        (<div
            ...
            <motion.h2
                style={{
                    ...
                    opacity: textOpacity,
                }} className=" text-slate-700 text-3xl lg:text-5xl font-bold mb-20 text-center">
                Let's dive further into the JS Pedia world and <br />
            ...
            {/* Base area */}
            <div
                className="h-[22rem] w-[32rem] bg-gray-200 rounded-2xl overflow-hidden relative -z-10">
                {/* above keyboard bar */}
                ...
                {showGradient && <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t from-white via-white to-transparent z-50"></div>}
            </div>
        </div>)
    );
};
    ...
    return (
        (<div className="relative [perspective:800px]">
            <div
                ...
                className="h-[12rem] w-[32rem] bg-neutral-900 rounded-2xl p-2 relative">
                <div
                    style={{
                        boxShadow: "0px 2px 0px 2px var(--neutral-900) inset",
                    }}
                    className="absolute inset-0 bg-neutral-900 rounded-lg flex items-center justify-center">
                </div>
            </div>
            <motion.div
                style={{
                ...
                <div className="absolute inset-0 bg-slate-900 rounded-lg flex justify-center items-center">
                    <span className="text-gray-200 text-3xl font-bold scale-y-[1.25]">JS Pedia Platforms</span>
                </div>
            </motion.div>
        </div>)
    );
...
export const Row = ({ children }) => <div className="flex gap-[2px] mb-[2px] w-full flex-shrink-0">
    {children}
</div>
...
export default function LaptopParallaxScrollSection() {
    return (
        <div className="overflow-hidden bg-neutral-100 w-full">
            <LaptopScroll
                src={`/linear.webp`}
                showGradient={false}
            />
